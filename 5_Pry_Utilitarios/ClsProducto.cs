...
namespace Utilitarios
{
    public class ClsProducto
    {
        ...
        public string presio_prome_detalle { get; set; }
        ...
        public ClsProducto() { }
        public ClsProducto(int id, string name, int id_categoria, string marca, string presio_prome, string descripcion , int cantida_total , string unida_product , int  id_producto_detalle  , string presio_prome_detalle , int cantidad_producto_venta , DateTime stock_entry_date , DateTime fabrication_date , DateTime expiration_date)
        {
            this.id = id; 
            this.name = name; 
