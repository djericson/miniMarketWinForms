...
namespace xDialog
{
    ...
    class MsgBox : Form
    {
        ...
        private void butoncuston()
        {
            ...
            btnOK3.Text = "edit";
            btnOK.Click += ButtonClick;
            btnOK2.Click += ButtonClick;
            btnOK3.Click += ButtonClick;
            this._buttonCollection.Add(btnOK);
            this._buttonCollection.Add(btnOK2);
            this._buttonCollection.Add(btnOK3);
        }
        ...
        private static void ButtonClick(object sender, EventArgs e)
        {
            ...
            switch (btn.Text)
            {
                ...
                case "delete":
                    value.buttonResult = "delete";
                    break;
                case "omitir":
                    value.buttonResult = "omitir";
                    break;
                case "edit":
                    value.buttonResult = "edit";
                    break;
            }
